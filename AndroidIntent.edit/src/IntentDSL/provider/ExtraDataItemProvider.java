...
/**
 * This is the item provider adapter for a {@link IntentDSL.ExtraData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtraDataItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExtraData_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExtraData_type_feature", "_UI_ExtraData_type"),
				 IntentDSLPackage.Literals.EXTRA_DATA__TYPE,
				 true,
				 false,
				 false,
