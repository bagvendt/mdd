...
/**
 * This is the item provider adapter for a {@link IntentDSL.Intent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntentItemProvider
	extends NamedInstanceItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Intent_action_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Intent_action_feature", "_UI_Intent_type"),
				 IntentDSLPackage.Literals.INTENT__ACTION,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Data URI feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDataURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Intent_dataURI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Intent_dataURI_feature", "_UI_Intent_type"),
				 IntentDSLPackage.Literals.INTENT__DATA_URI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Intent_category_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Intent_category_feature", "_UI_Intent_type"),
				 IntentDSLPackage.Literals.INTENT__CATEGORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPermissionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Intent_permission_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Intent_permission_feature", "_UI_Intent_type"),
				 IntentDSLPackage.Literals.INTENT__PERMISSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IntentDSLPackage.Literals.INTENT__EXTRA_DATA);
			childrenFeatures.add(IntentDSLPackage.Literals.INTENT__RETURN_DATA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(IntentDSLPackage.Literals.INTENT__EXTRA_DATA,
				 IntentDSLFactory.eINSTANCE.createExtraData()));

		newChildDescriptors.add
			(createChildParameter
				(IntentDSLPackage.Literals.INTENT__RETURN_DATA,
				 IntentDSLFactory.eINSTANCE.createExtraData()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == IntentDSLPackage.Literals.INTENT__EXTRA_DATA ||
			childFeature == IntentDSLPackage.Literals.INTENT__RETURN_DATA;
